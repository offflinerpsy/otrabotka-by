    ...
    <div className="bg-white">
      ...
      <section className="relative py-16 md:py-24 px-[20px] md:px-[100px] lg:px-[260px] overflow-hidden">
        ...
        >
          ...
          <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[28px] text-[18px] text-black tracking-[0.36px] mb-8" style={{ fontVariationSettings: "'wdth' 100" }}>
            Полный цикл: сбор отработанных масел в Беларуси и переработка на собственном заводе путем вакуумной дистилляции
          </p>
        </motion.div>
        ...
        >
          {stats.map((stat, idx) => (
            ...
            >
              <p className="font-['Roboto:Bold',sans-serif] font-bold leading-[60px] text-[48px] text-black mb-2" style={{ fontVariationSettings: "'wdth' 100" }}>
                {stat.value}
              </p>
              <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[24px] text-[18px] text-black" style={{ fontVariationSettings: "'wdth' 100" }}>
                {stat.label}
              </p>
            </motion.div>
          ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {outputProducts.map((product, idx) => (
              ...
              >
                ...
                <div className="mb-4">
                  <div className="size-[50px] bg-gradient-to-br from-[#fcd900]/20 to-[#fcd900]/10 rounded-xl flex items-center justify-center">
                    <product.icon className="size-[25px] text-black" strokeWidth={2} />
                  </div>
                </div>

                <div className="mb-3">
                  <p className={`font-['Roboto:Bold',sans-serif] font-bold leading-[40px] text-[32px] bg-gradient-to-r ${product.color} bg-clip-text text-transparent mb-1`} style={{ fontVariationSettings: "'wdth' 100" }}>
                    {product.percentage}
                  </p>
                  <h3 className="font-['Roboto:Medium',sans-serif] leading-[26px] text-[18px] text-black" style={{ fontVariationSettings: "'wdth' 100" }}>
                    {product.name}
                  </h3>
                </div>

                <p className="font-['Roboto:Regular',sans-serif] leading-[22px] text-[15px] text-black opacity-70" style={{ fontVariationSettings: "'wdth' 100" }}>
                  {product.description}
                </p>
              </motion.div>
            ))}
      ...
      <section className="relative py-16 md:py-24 px-[20px] md:px-[100px] lg:px-[260px] bg-black text-white overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-10">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1740914994657-f1cdffdc418e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1920"
            alt="Background"
        ...
        <div className="relative z-10 text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="font-['Roboto:Medium',sans-serif] leading-[50px] text-[32px] md:text-[40px] text-white mb-6" style={{ fontVariationSettings: "'wdth' 100" }}>
              Готовы начать сотрудничество?
            </h2>
            <p className="font-['Roboto:Regular',sans-serif] text-[18px] text-white opacity-70 mb-10 max-w-[700px] mx-auto" style={{ fontVariationSettings: "'wdth' 100" }}>
